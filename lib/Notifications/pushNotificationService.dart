    ...
    newRequestsRef
      ...
      if (dataSnapShot.value != null) {
        ...
        String dropOffAddress =
            dataSnapShot.value['destination_address'].toString();

        String paymentMethod = dataSnapShot.value['payment_method'].toString();

        String commuter_name = dataSnapShot.value["commuter_name"];
        String commuter_contactNum = dataSnapShot.value["commuter_contactNum"];
        ...
        rideDetails.commuter_name = commuter_name;
        rideDetails.commuter_contactNum = commuter_contactNum;
